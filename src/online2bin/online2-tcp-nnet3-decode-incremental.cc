...
int main(int argc, char *argv[]) {
  try {
    ...
    /* [!SEE_THIS] : INCREMENTAL DECODER CONFIG */
    ...
    while (true) {
      ...
      /* [!SEE_THIS] : INCREMENTAL DECODER OBJECT */
      SingleUtteranceNnet3IncrementalDecoder decoder(decoder_opts,
                                                     trans_model,
                                                     decodable_info,
                                                     *decode_fst,
                                                     &feature_pipeline);
        ...
        while (true) {
          ...
          if (eos) {
            ...
            if (decoder.NumFramesDecoded() > 0) {
              ...
              /* [!SEE_THIS] method GetLattice() has different function signature */
              int32 num_frames_to_include = decoder.NumFramesDecoded();
              bool use_final_probs = true;
              const CompactLattice& lat = decoder.GetLattice(num_frames_to_include, use_final_probs);
          ...
          if (samp_count > check_count) {
            if (decoder.NumFramesDecoded() > 0) {
              ...
              /* [!SEE_THIS] method GetLattice() has different function signature */
              int32 skip_last_n_frames = 10;  // 30ms steps, 10 is a "guessed" value, can be experimented with
              int32 num_frames_to_include = max(
                  decoder.NumFramesDecoded() - skip_last_n_frames,
                  decoder.NumFramesInLattice()
              );
              ...
              */
              ...
              if (produce_time) {
                ...
                /* [!SEE_THIS] */
                int32 t_end = frame_offset + num_frames_to_include;
                /* [!SEE_THIS] */
